...
AI Agent (Claude Code / Codex / Gemini)
    ...
    │   Figma plugin ─────→ Local inspection + batch executor (54 action types, 30-60x faster)
    │
...
54 action types — stable named references, component properties and nested overrides, name-resolved variables/styles, safe image/SVG ingestion, sections, reactions, gradients, auto-layout, and text controls. See `figma://actions` MCP resource or [USAGE.md](USAGE.md) for the catalog.
